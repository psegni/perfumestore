...
1. Visit http://localhost/admin/register to create the admin account (only works once)

2. Login at http://localhost]/admin/login

3. Manage perfumes at http://localhost/admin/dashboard
